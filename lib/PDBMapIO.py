...
class PDBMapIO(PDBIO):
  ...
  def upload_genomic_data(self,dstream,dname):
    ...
    for i,record in enumerate(dstream):
      ...
      query += "easafr_Nhat,saseur_Nhat,sasafr_Nhat,eurafr_Nhat,allpop_Nhat,"
      query += "amreas_Dhat,amrsas_Dhat,amreur_Dhat,amrafr_Dhat,eassas_Dhat,easeur_Dhat,"
      query += "easafr_Dhat,saseur_Dhat,sasafr_Dhat,eurafr_Dhat,allpop_Dhat,"
      query += "amreas_Fst,amrsas_Fst,amreur_Fst,amrafr_Fst,eassas_Fst,easeur_Fst,"
      query += "easafr_Fst,saseur_Fst,sasafr_Fst,eurafr_Fst,allpop_Fst,"
      query += "snpsource,format,genotypes) VALUES "
