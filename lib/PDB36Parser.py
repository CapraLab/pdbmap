...
# Extensions to biopython to parse Modbase Models in Hybrid36 format
# Patched by Chris Moth, who makes zero claim on anything done here.
# See
# http://cci.lbl.gov/hybrid_36/

"""Parser for PDB hybrid 36 files."""
...
###############################################################
# IMPORT the Hybrid36 supporting functions encoded at
# http://cci.lbl.gov/hybrid_36/
#
from lib import hybrid36

# If PDB spec says "COLUMNS 18-20" this means line[17:20]


class PDB36Parser(object):
    """Parse a PDB file and return a Structure object."""

    def __init__(
        self, PERMISSIVE=True, get_header=False, structure_builder=None, QUIET=False
    ):
        """Create a PDB36Parser object.

        The PDB parser call a number of standard methods in an aggregated
        StructureBuilder object. Normally this object is instanciated by the
        PDB36Parser object itself, but if the user provides his/her own
        ...
        for i in range(0, len(coords_trailer)):
            ...
            if record_type == "ATOM  " or record_type == "HETATM":
                ...
                try:
                    ...
                    serial_number = 0
                if serial_number == 0:
                    serial_number = hybrid36.hy36decode(5,line[6:11])

                resseq = hybrid36.hy36decode(4,line[22:26])  # sequence identifier
