...
if [ "$#" -lt 3 ]; then
  echo "usage: "
  echo "  pymol_pdbmap.sh pdbid variants density-radius"
  exit 1
fi
...
cmd1="run $DIR/overwrite_pymol.py; "
...
cmd2="run $DIR/overwrite_pymol.py; "
...
$DIR/cluster_and_visualize.r $pdbid
cmd3="run $DIR/overwrite_pymol.py; "
...
cmd4="run $DIR/overwrite_pymol.py; "
