...
version="108_38"
download_date="2024-01-19"
replace_With_pw="obfucate"
echo ENSEMBL version is $version
echo  # cd to homo_sapiens_variation_108_38 from
cd /dors/capra_lab/data/ensembl/$download_date/homo_sapiens_variation_$version
...
mysqlimport --fields-terminated-by='\t' --fields-escaped-by=\\ homo_sapiens_variation_$version -p$replace_with_pw -L transcript_variation.txt | tee -a mysqlimport.log
if [$? -eq 0 ]; then
